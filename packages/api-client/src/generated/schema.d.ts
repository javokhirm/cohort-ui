...
export interface paths {
    ...
    "/api/v1/public/platform-leads": {
        ...
        get?: never;
        put?: never;
        /** Capture a lead from an unauthenticated public source */
        post: operations["PlatformLeadsController_create"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/super-admin/platform-leads": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Leads across every source (source/search/date filters) */
        get: operations["PlatformLeadsAdminController_list"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/super-admin/platform-leads/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** A single lead */
        get: operations["PlatformLeadsAdminController_detail"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/super-admin/notification-settings/sms": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** The platform's shared Eskiz account: provider, sender, configured? */
        get: operations["PlatformNotificationSettingsController_getStatus"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/super-admin/notification-settings/sms/balance": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Remaining balance on the platform account
         * @description Returns a null amount when the provider exposes no balance endpoint or is unreachable — a gateway outage must not break the console screen.
         */
        get: operations["PlatformNotificationSettingsController_getBalance"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/super-admin/notification-settings/sms/test": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Send a test message through the platform account
         * @description Bypasses the rules engine and the outbox. Credential failures come back as `success: false` with a translated reason, never a 5xx.
         */
        post: operations["PlatformNotificationSettingsController_test"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/super-admin/notification-templates/defaults": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * The code-owned default SMS templates
         * @description Read-only — defaults are never edited over the API, only in the codebase.
         */
        get: operations["PlatformNotificationTemplatesController_listDefaults"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/super-admin/notification-templates/moderation": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * SMS gateway moderation status for the platform account
         * @description Refreshed from the gateway on read — it never calls back. Empty when the platform account has no configured credentials.
         */
        get: operations["PlatformNotificationTemplatesController_moderationStatus"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/super-admin/notification-templates/moderation/sync": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Submit the platform’s default SMS copy to the gateway for moderation
         * @description Reconciles against the account’s existing templates first and submits only what is missing — safe to press repeatedly. Zeroed counts when the platform account has no configured credentials.
         */
        post: operations["PlatformNotificationTemplatesController_syncModeration"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/manage/schedule/rooms": {
        ...
        /** Room allocation: one day's classes laid out by room, with free rooms, booked minutes and double-bookings */
        get: operations["ScheduleController_rooms"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/manage/notification-templates": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** List notification templates (paginated, filterable) */
        get: operations["NotificationTemplatesController_list"];
        put?: never;
    ...
    "/api/v1/manage/notification-templates/preview": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Render a draft body against sample values (no send, no save) */
        post: operations["NotificationTemplatesController_preview"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/manage/notification-templates/moderation": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * SMS gateway moderation status for this center’s message copy
         * @description Uzbek SMS gateways deliver only pre-approved text. Every default template and every customization is submitted for moderation on save; this reports what the gateway has decided. Refreshed from the gateway on read — it never calls back. Empty when the center has no resolvable SMS credentials.
         */
        get: operations["NotificationTemplatesController_moderationStatus"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/manage/notification-templates/moderation/sync": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Submit this center’s default SMS copy to the gateway for moderation
         * @description Reconciles the code-owned default templates against the templates the gateway account already holds and submits only what is missing — a text the gateway already has verbatim is adopted, never resubmitted, so this is safe to press repeatedly. Returns zeroed counts when the center has no resolvable SMS credentials.
         */
        post: operations["NotificationTemplatesController_syncModeration"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/manage/notification-templates/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["NotificationTemplatesController_findOne"];
        put?: never;
        post?: never;
        /**
         * Soft-delete a notification template
         * @description Messages already sent from it keep their rendered copy — the outbox is an audit record of what was actually sent.
         */
        delete: operations["NotificationTemplatesController_remove"];
        options?: never;
        head?: never;
        /** Update a notification template */
        patch: operations["NotificationTemplatesController_update"];
        trace?: never;
    };
    "/api/v1/manage/notification-triggers": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** List the available notification triggers (localized) */
        get: operations["NotificationRulesController_listTriggers"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/manage/notification-rules": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** List notification rules (paginated, filterable) */
        get: operations["NotificationRulesController_list"];
        put?: never;
        /** Create a notification rule */
        post: operations["NotificationRulesController_create"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/manage/notification-rules/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["NotificationRulesController_findOne"];
        put?: never;
        post?: never;
        /**
         * Soft-delete a notification rule
         * @description Prefer the toggle to silence a rule — deleting loses the configuration. Notifications it already produced are unaffected.
         */
        delete: operations["NotificationRulesController_remove"];
        options?: never;
        head?: never;
        /**
         * Update a notification rule
         * @description `trigger` cannot be changed: it determines the rule's legal audiences, offset and template variables. Delete and recreate instead.
         */
        patch: operations["NotificationRulesController_update"];
        trace?: never;
    };
    "/api/v1/manage/notification-rules/{id}/toggle": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        patch: operations["NotificationRulesController_toggle"];
        trace?: never;
    };
    "/api/v1/manage/notifications": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** List sent/queued notifications (paginated, filterable) */
        get: operations["NotificationsController_list"];
        put?: never;
        /**
         * Manual send / broadcast
         * @description Exactly one recipient scope: recipientUserIds OR recipientGroupId OR recipientBranchId. One notification row is created per resolved recipient and queued for dispatch.
         */
    ...
    "/api/v1/manage/notifications/stats": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Aggregate delivery counts and billable SMS segments */
        get: operations["NotificationsController_stats"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/manage/notifications/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get one notification, with its payload and failure reason */
    ...
    "/api/v1/manage/notifications/{id}/retry": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Re-queue a failed notification for another attempt */
        post: operations["NotificationsController_retry"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/manage/notification-settings": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Channels with no stored row are returned as disabled defaults rather than omitted, so the console can render a complete list.
         */
        get: operations["NotificationSettingsController_list"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/manage/notification-settings/{channel}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: operations["NotificationSettingsController_findOne"];
        /**
         * Create or replace a channel's settings
         * @description An upsert, because the row is a singleton per (tenant, channel). Omit `credentials` to leave stored secrets untouched; pass null to clear them and fall back to the platform account.
         */
        put: operations["NotificationSettingsController_upsert"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/v1/manage/notification-settings/{channel}/test": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["NotificationSettingsController_test"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/manage/notification-settings/{channel}/balance": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Remaining provider balance for the account in effect
         * @description Returns a null amount when the provider exposes no balance endpoint or is unreachable — a gateway outage must not break the settings screen.
         */
        get: operations["NotificationSettingsController_balance"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        CreatePlatformLeadDto: {
            /** @example Alisher Karimov */
            name: string;
            /** @example alisher@markaz.uz */
            email: string;
            /** @example +998901234567 */
            phone?: string;
            /** @example Bilim Plus */
            centerName?: string;
            /** @description Free-text note from the submitter. */
            message?: string;
            /**
             * @description Where this lead was captured — the caller identifies itself.
             * @example WEBSITE
             */
            source: string;
        };
        ...
        TestSmsDto: {
            /**
             * @description Uzbek number, E.164 or local. Format is checked by the service, which answers with a localized reason.
             * @example +998901234567
             */
            phone: string;
            /** @description Custom test body. Defaults to a localized standard message. */
            message?: string;
        };
        ChangeMyPasswordDto: {
            newPassword: string;
        ...
        CreateStudentDto: {
            ...
            lastName: string;
            /**
             * @description E.164 phone number. Optional: students sign in with their studentCode, so a minor with no number of their own needs no entry here.
             * @example +998901234567
             */
            phone?: string;
            email?: string;
        ...
        /**
         * @description Known codes drive the rules engine; a center may also define its own for manual broadcasts.
         * @enum {string}
         */
        NotificationTemplateCode: "INVOICE_ISSUED" | "INVOICE_DUE" | "INVOICE_OVERDUE" | "LATE_FEE_APPLIED" | "ENROLLMENT_SUSPENDED" | "ENROLLMENT_REACTIVATED" | "ENROLLMENT_AUTO_CANCELLED" | "ABSENCE_ALERT" | "WELCOME" | "PAYMENT_RECEIVED" | "SCHEDULE_CHANGE" | "RESULTS_PUBLISHED" | "SUBSCRIPTION_EXPIRING" | "SUBSCRIPTION_EXPIRED" | "SUBSCRIPTION_RENEWED";
        CreateNotificationTemplateDto: {
            /**
             * @description Known codes drive the rules engine; a center may also define its own for manual broadcasts.
             * @example INVOICE_DUE
             */
            code: components["schemas"]["NotificationTemplateCode"];
            /** @enum {string} */
             ...
             */
            locale: "uz" | "ru" | "en";
            /** @description EMAIL channel only */
            subject?: string | null;
            /**
             * @description Body with {{variable}} placeholders. Variables are validated against the code's trigger — an unknown one is rejected rather than rendering empty.
             * @example Cohort: {{studentName}} uchun {{amount}} to'lov {{dueDate}}.
             */
            body: string;
            /** @default true */
            isActive: boolean;
        ...
        CreateNotificationRuleDto: {
            /**
             * @description The business moment to react to. Immutable after creation — see PATCH.
             * @enum {string}
             */
            trigger: "INVOICE_ISSUED" | "INVOICE_DUE_SOON" | "INVOICE_OVERDUE" | "PAYMENT_RECEIVED" | "LATE_FEE_APPLIED" | "ENROLLMENT_SUSPENDED" | "ENROLLMENT_REACTIVATED" | "ENROLLMENT_AUTO_CANCELLED" | "STUDENT_ABSENT" | "RESULTS_PUBLISHED" | "STUDENT_WELCOME" | "SUBSCRIPTION_EXPIRING" | "SUBSCRIPTION_EXPIRED" | "SUBSCRIPTION_RENEWED";
            /**
             * @description At least one channel. Duplicates are rejected. Only channels Cohort can currently deliver on are accepted — a rule on any other would queue messages that are never sent and never fail.
             * @example [
             *       "SMS"
             *     ]
             */
            channels: "SMS"[];
            /**
             * @description Must be one of the audiences the trigger allows — see GET /manage/notification-triggers.
             * @enum {string}
             */
            audience: "STUDENT" | "PRIMARY_GUARDIAN" | "STUDENT_AND_GUARDIAN" | "BILLING_CONTACTS";
            /** @description Template code to render. Defaults to the trigger's default code. */
            templateCode?: string;
            /**
             * @description Days relative to the anchor date: negative = before, 0 = on the day, positive = after. Required for SCHEDULED triggers, rejected for EVENT ones.
             * @example -3
             */
            offsetDays?: number | null;
            /** @description Null = applies tenant-wide */
            branchId?: number | null;
            /** @default true */
            isActive: boolean;
        };
        ...
        ToggleNotificationRuleDto: {
            /** @description true = the rule sends; false = configured but silenced */
            isActive: boolean;
        };
        SendNotificationDto: {
            /**
             * @description Only channels Cohort can currently deliver on. A broadcast on any other would queue rows nothing drains.
             * @enum {string}
             */
            channel: "SMS";
            /** @description Render from this template, or supply a raw `body`. */
            templateId?: number | null;
            /** @description Required when no templateId is given. Supports {{variables}}. */
            body?: string;
            /** @description Specific users. One of userIds / groupId / branchId. */
            recipientUserIds?: number[];
            /** @description All actively enrolled students in a group */
            recipientGroupId?: number;
            /** @description All active students in a branch */
            ...
            /** @description ISO datetime. Omit to send as soon as possible. */
            scheduledAt?: string;
        };
        ChannelCredentialsDto: {
            /** @description Eskiz account email */
            login: string;
            /** @description Eskiz account password. Encrypted at rest. */
            password: string;
        };
        UpsertChannelSettingDto: {
            /** @description Channel-wide master switch. false silences every rule on this channel at once without editing any of them. */
            isEnabled: boolean;
            /**
             * @description Gateway adapter key. Null = the platform default.
             * @example eskiz
             */
            provider?: string | null;
            /** @description Sender nickname shown to the recipient. Must be registered with the provider against whichever account is in effect. Null = platform default. */
            senderName?: string | null;
            /** @description The center's own gateway account. Omit to leave stored credentials untouched; null to clear them and fall back to the platform account. */
            credentials?: components["schemas"]["ChannelCredentialsDto"] | null;
            /** @description Safety cap on messages per day. Over the cap, rows wait for the next day rather than failing. Null = uncapped. */
...
export interface operations {
    AuthController_login: {
        parameters: {
            query?: never;
            header?: {
                /** @description Client app the request comes from (`admin` | `teacher`). When set, a user holding none of that app's roles is refused with 403 FORBIDDEN_ROLE. */
                "x-client-app"?: string;
            };
            path?: never;
            cookie?: never;
    ...
    PlatformLeadsController_create: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreatePlatformLeadDto"];
            };
        };
        responses: {
            201: {
    ...
    PlatformLeadsAdminController_list: {
        parameters: {
            query?: {
                page?: number;
                limit?: number;
                /** @description Free-text over name, email, phone and center name */
                search?: string;
                source?: string;
                from?: string;
                to?: string;
    ...
    PlatformLeadsAdminController_detail: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    PlatformNotificationSettingsController_getStatus: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    PlatformNotificationSettingsController_getBalance: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    PlatformNotificationSettingsController_test: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["TestSmsDto"];
            };
        };
        responses: {
            201: {
    ...
    PlatformNotificationTemplatesController_listDefaults: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    PlatformNotificationTemplatesController_moderationStatus: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    PlatformNotificationTemplatesController_syncModeration: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    ScheduleController_rooms: {
        parameters: {
            query: {
                /** @description Filter to these branch ids (comma-separated or repeated); must be within your branch scope */
                branchIds?: number[];
                /** @description Required. The calendar day to lay out. */
                date: string;
            };
            header?: never;
            path?: never;
    ...
    NotificationTemplatesController_list: {
        parameters: {
            query?: {
                page?: number;
                limit?: number;
    ...
    NotificationTemplatesController_preview: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    NotificationTemplatesController_moderationStatus: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    NotificationTemplatesController_syncModeration: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    NotificationTemplatesController_findOne: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    NotificationTemplatesController_remove: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    NotificationRulesController_listTriggers: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    NotificationRulesController_list: {
        parameters: {
            query?: {
                page?: number;
                limit?: number;
                trigger?: "INVOICE_ISSUED" | "INVOICE_DUE_SOON" | "INVOICE_OVERDUE" | "PAYMENT_RECEIVED" | "LATE_FEE_APPLIED" | "ENROLLMENT_SUSPENDED" | "ENROLLMENT_REACTIVATED" | "ENROLLMENT_AUTO_CANCELLED" | "STUDENT_ABSENT" | "RESULTS_PUBLISHED" | "STUDENT_WELCOME" | "SUBSCRIPTION_EXPIRING" | "SUBSCRIPTION_EXPIRED" | "SUBSCRIPTION_RENEWED";
                channel?: "SMS" | "TELEGRAM" | "EMAIL" | "PUSH";
                /** @description Omit for all rules; `null` for tenant-wide rules only */
                branchId?: number | null;
                isActive?: boolean;
            };
            header?: never;
    ...
    NotificationRulesController_create: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    NotificationRulesController_findOne: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    NotificationRulesController_remove: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    NotificationRulesController_update: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    NotificationRulesController_toggle: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ToggleNotificationRuleDto"];
            };
        };
        responses: {
            200: {
    ...
    NotificationsController_list: {
        parameters: {
            query?: {
                ...
                /** @description Only messages produced by this rule */
                ruleId?: number;
                /** @description Inclusive lower bound on createdAt (ISO) */
                from?: string;
                /** @description Inclusive upper bound on createdAt (ISO) */
                to?: string;
            };
            header?: never;
            path?: never;
    ...
    NotificationSettingsController_list: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    NotificationSettingsController_findOne: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    NotificationSettingsController_upsert: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UpsertChannelSettingDto"];
            };
        };
        responses: {
            200: {
    ...
    NotificationSettingsController_test: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["TestChannelDto"];
            };
        };
        responses: {
            201: {
    ...
    NotificationSettingsController_balance: {
        parameters: {
            query?: never;
            header?: never;
            path: {
