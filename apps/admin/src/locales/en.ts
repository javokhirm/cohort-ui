...
export const en: TranslationsOf<typeof uz> = {
	...
	people: {
		...
		guardiansPage: {
			title: 'Guardians',
			description: 'View, edit, and link parents and guardians to students',
			...
			moreStudents_one: '+{{count}} more',
			moreStudents_other: '+{{count}} more',
			empty: 'No guardians found',
			emptyDescription: 'No guardians have been added yet.',
			emptyFiltered: 'No guardians match your search',
			detail: {
				title: 'Guardian details',
				actionsLabel: 'Guardian actions',
				edit: 'Edit',
				save: 'Save',
				cancel: 'Cancel',
				saved: 'Details updated',
				saveFailed: 'Could not update',
				field: {
					firstName: 'First name *',
					lastName: 'Last name *',
					phone: 'Phone',
				...
				unlink: 'Unlink',
				unlinkConfirm: 'Unlink {{name}}?',
				unlinked: 'Unlinked',
				unlinkFailed: 'Could not unlink',
				delete: 'Delete guardian',
				deleteConfirmTitle: 'Delete this guardian entirely?',
				deleteConfirmDescription:
					'{{name}} will be unlinked from every student and removed from the system. This cannot be undone.',
				deleted: 'Guardian deleted',
				deleteFailed: 'Could not delete guardian',
			},
			linkDialog: {
				title: 'Link a student',
				description: 'Connect this guardian to an existing student.',
				student: 'Student *',
				relation: 'Relation *',
				primaryLabel: 'Primary guardian',
				pickupLabel: 'Can pick up',
				submit: 'Link',
				linked: 'Student linked',
				linkFailed: 'Could not link student',
			},
		},
	},
	hr: {
		...
		schedule: {
			...
			rooms: {
				...
				summary: {
					...
					classes: 'Classes',
					conflicts: 'Conflicts',
					conflictsHint: 'Overlapping classes in one room',
					allClear: 'No conflicts',
					unplaced: 'Unplaced',
					unplacedHint: 'Give these classes a room',
				},
				emptyTitle: 'No rooms in the selected branches',
				emptyDescription:
					'Change the branch selection, or add a room on the Rooms page.',
				noMatchTitle: 'No rooms match this filter',
				noMatchDescription: 'Pick another filter, or view all rooms.',
				loadError: 'Failed to load room occupancy. Please refresh.',
			},
			today: 'Today',
