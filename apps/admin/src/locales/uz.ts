...
export const uz = {
	...
	people: {
		...
		detail: {
			...
			performance: {
				...
				emptyDescription:
					'Oʻquvchi guruhlarida darslar belgilangach, davomat va kunlik baholar shu yerda koʻrinadi.',
				emptyFiltered: 'Bu filtrlarga mos dars topilmadi',
				...
				attendanceRate: 'Davomat koʻrsatkichi',
				attendanceMeta: '{{total}} darsdan {{attended}} tasida qatnashgan',
				belowPolicy: '{{threshold}}% dan past',
				averageMark: 'Oʻrtacha dars bahosi',
				markMeta_one: '{{count}} baholangan dars',
				markMeta_other: '{{count}} baholangan dars',
				unmarkedMeta_one: '{{count}} dars baholanmagan',
				unmarkedMeta_other: '{{count}} dars baholanmagan',
				sessionHistory: 'Darslar tarixi',
				notMarked: 'Baholanmagan',
				noTopic: 'Mavzu koʻrsatilmagan',
				/** Baho shkalasi nomlari — `type`/`maxPoints` asosida tuziladi. */
		...
		guardiansPage: {
			...
			detail: {
				...
				linkedStudentsTitle: 'Bogʻlangan oʻquvchilar',
				linkStudent: 'Oʻquvchi bogʻlash',
			...
			linkDialog: {
				...
				description: 'Ushbu vasiyni mavjud oʻquvchiga bogʻlang.',
				student: 'Oʻquvchi *',
				relation: 'Qarindoshligi *',
				primaryLabel: 'Asosiy vasiy',
				pickupLabel: 'Olib ketishi mumkin',
				submit: 'Bogʻlash',
				linked: 'Oʻquvchi bogʻlandi',
				linkFailed: 'Oʻquvchini bogʻlab boʻlmadi',
			},
		},
	},
	hr: {
	...
	subscription: {
		...
		banner: {
			message:
				'Obunangiz {{date}} sanasida tugaydi. Uzilishlarning oldini olish uchun rejangizni yangilang.',
			renew: 'Yangilash',
			dismiss: 'Yopish',
		},
		renewalPrice: 'Yangilash narxi',
		active: {
			period: 'Davr',
		...
		blocked: {
			...
			description:
				'Hisobingizga kirishni davom ettirish uchun rejangizni yangilang.',
			expiredOn: 'Amal qilish muddati',
			currentPlan: 'Joriy reja',
			renew: 'Yangilash',
			ownerOnly: 'Yangilash uchun markaz egasiga murojaat qiling',
		},
		features: {
			title: 'Reja imkoniyatlari',
			empty: 'Qoʻshimcha imkoniyatlar yoʻq',
	...
	notifications: {
		title: 'Aloqa',
		description: 'Xabarlar qachon yuboriladi, nima deydi va aslida nima yetib bordi',
		tab: {
			rules: 'Qoidalar',
		...
		console: {
			smsOn: 'SMS yoqilgan',
			smsOperational: 'SMS ishlayapti',
			smsOff: 'SMS oʻchirilgan',
			smsBroken: 'SMS sozlanmagan',
			usage: '{{sent}} / {{limit}} bugun',
			usageUncapped: '{{sent}} bugun',
			sendMessage: 'Xabar yuborish',
			newBroadcast: 'Yangi ommaviy xabar',
			brokenTitle: 'SMS yoqilgan, ammo hech narsa yuborilmaydi',
			brokenBody:
				'Qoidalar ishlashda davom etadi va xabarlar navbatga qoʻshilaveradi — bu tuzatilmaguncha ularning har biri muvaffaqiyatsiz boʻladi.',
			openSettings: 'Sozlamalarni ochish',
		},
		rules: {
			title: 'Yuborish qoidalari',
			saveFailed: 'Qoidani saqlab boʻlmadi',
			deleteFailed: 'Qoidani oʻchirib boʻlmadi',
			toggleFailed: 'Qoida holatini oʻzgartirib boʻlmadi',
			description:
				'Qoida boʻlmasa hech narsa yuborilmaydi. Har bir qoida hodisani kanal, qabul qiluvchi va shablon bilan bogʻlaydi.',
			add: 'Qoida qoʻshish',
			newRule: 'Yangi qoida',
			edit: 'Qoidani tahrirlash',
			timingBefore: '{{days}} kun oldin',
			timingOn: 'Shu kuni',
			timingAfter: '{{days}} kun keyin',
			empty: 'Hali qoida yoʻq. Xabarlar yuborilishi uchun birinchi qoidani qoʻshing.',
			loadError: 'Qoidalarni yuklab boʻlmadi. Sahifani yangilang.',
			created: 'Qoida yaratildi',
			updated: 'Qoida yangilandi',
			deleted: 'Qoida oʻchirildi',
			enabled: 'Qoida yoqildi',
			disabled: 'Qoida oʻchirildi',
			deleteTitle: 'Qoidani oʻchirish',
			deleteDescription:
				'“{{name}}” qoidasi oʻchiriladi. Qoidani butunlay oʻchirish oʻrniga uni vaqtincha oʻchirib qoʻyish mumkin.',
			toggleAria: '{{name}} qoidasini yoqish/oʻchirish',
			scheduledGroup: 'Rejalashtirilgan eslatmalar',
			eventGroup: 'Hodisaga asoslangan',
			offsetBefore: 'Muddatdan {{days}} kun oldin',
			offsetOn: 'Muddat kuni',
			offsetAfter: 'Muddatdan {{days}} kun keyin',
			column: {
				name: 'Nomi',
				trigger: 'Hodisa',
				timing: 'Vaqti',
			...
			field: {
				name: 'Qoida nomi',
				nameHint: 'Masalan: “Muddatdan 3 kun oldin”',
				trigger: 'Hodisa',
				triggerHint: 'Yaratilgandan keyin oʻzgartirilmaydi',
				channels: 'Kanallar',
				audience: 'Qabul qiluvchilar',
				templateCode: 'Shablon kodi',
				templateCodeHint:
					'Hodisa asosida belgilanadi — matnini “Shablonlar” boʻlimida tahrirlang',
				offsetDays: 'Kunlar farqi',
				offsetDaysHint:
					'Manfiy — muddatdan oldin, 0 — muddat kuni, musbat — muddatdan keyin',
				isActive: 'Faol',
				isActiveHint: 'Oʻchirilganda qoida saqlanadi, lekin xabar yubormaydi',
			},
			validation: {
				channelsRequired: 'Kamida bitta kanal tanlang',
				offsetRange: 'Kunlar farqi -365 va 365 orasida boʻlishi kerak',
			},
			variablesHint: 'Bu hodisada mavjud oʻzgaruvchilar:',
			catalogHint:
				'Qabul qiluvchilar, oraliqlar va oʻzgaruvchilar hodisa katalogidan olinadi',
			filter: {
				all: 'Barchasi',
				active: 'Faol',
				paused: 'Pauzada',
				scheduled: 'Rejalashtirilgan',
				event: 'Hodisaga asoslangan',
			},
			kind: {
				scheduled: 'Rejali',
				event: 'Hodisa',
			},
			kindScheduled: 'REJALI',
			kindEvent: 'HODISA',
			scheduledHint: 'Muddat sanasiga nisbatan kun oraligʻida yuboriladi',
			eventHint: 'Hodisa qayd etilishi bilanoq yuboriladi — oraliqsiz',
			stepsCount: '{{count}} ta qadam — yuborish tartibida',
			stepCountOne: '1 qadam',
			countLabel: '{{count}} ta qoida',
			eventChip: 'HOZIR',
			openTemplateAria: '{{code}} shablonini ochish',
			filterEmpty: 'Ushbu filtrga mos qoida yoʻq',
			filterEmptyHint:
				'Barcha qoidalarga qayting yoki katalogdagi hodisa uchun yangisini yarating.',
		},
		templates: {
			title: 'Xabar shablonlari',
			saveFailed: 'Shablonni saqlab boʻlmadi',
			deleteFailed: 'Shablonni oʻchirib boʻlmadi',
			previewFailed: 'Koʻrib chiqib boʻlmadi',
			description:
				'Har bir kod, kanal va til uchun bitta shablon. Yuborishda qabul qiluvchining tili tanlanadi.',
			add: 'Shablon qoʻshish',
			edit: 'Shablonni tahrirlash',
			empty: 'Hali shablon yoʻq.',
			loadError: 'Shablonlarni yuklab boʻlmadi. Sahifani yangilang.',
			created: 'Shablon yaratildi',
			updated: 'Shablon yangilandi',
			deleted: 'Shablon oʻchirildi',
			deleteTitle: 'Shablonni oʻchirish',
			deleteDescription:
				'{{code}} ({{channel}} / {{locale}}) shabloni oʻchiriladi. Yuborilgan xabarlar oʻzgarmaydi.',
			column: {
				code: 'Kod',
				channel: 'Kanal',
				locale: 'Til',
			...
			selectPrompt: 'Shablonni tanlang',
			selectPromptHint:
				'Tanasini tahrirlash va koʻrib chiqish uchun roʻyxatdan xabar tanlang.',
			editDetails: 'Tafsilotlarni tahrirlash',
			revert: 'Bekor qilish',
			saveButton: 'Shablonni saqlash',
			usedBy: '{{count}} ta qoidada ishlatiladi',
			usedByNone: 'Hech qanday qoidada ishlatilmaydi',
			lastEdited: 'oxirgi tahrir {{date}}',
			variablesTitle: 'Ushbu shablon oʻzgaruvchilari',
			unknownVars:
			...
			revertDescription:
				'{{code}} ({{channel}} / {{locale}}) moslashtirilgan shabloni oʻchiriladi va standart shablon qayta ishlatiladi.',
			reverted: 'Standart shablonga qaytarildi',
		...
		outbox: {
			...
			retryFailed: 'Qayta yuborib boʻlmadi',
			sendFailed: 'Xabar yuborib boʻlmadi',
			description: 'Har bir xabarning holati, sababi va narxi',
			empty: 'Hali xabar yuborilmagan.',
			loadError: 'Xabarlarni yuklab boʻlmadi. Sahifani yangilang.',
			retry: 'Qayta yuborish',
			retried: 'Xabar qayta navbatga qoʻyildi',
			send: 'Xabar yuborish',
			sendTitle: 'Qoʻlda xabar yuborish',
			sent: '{{count}} xabar navbatga qoʻyildi',
			sentWithSkipped:
				'{{count}} xabar navbatga qoʻyildi, {{skipped}} tasi oʻtkazib yuborildi (raqam yoʻq)',
			column: {
				createdAt: 'Vaqti',
				recipient: 'Kimga',
				channel: 'Kanal',
			...
			summary: {
				...
				deliveredHint: 'operator tasdiqladi',
				failed: 'Xatolik',
				failedHint: 'qayta yuborish mumkin',
				inFlight: 'Yuborilmoqda',
				inFlightHint: 'navbatda yoki yuborilmoqda',
				segments: 'Segmentlar',
				segmentsHint: 'hisoblanadigan qismlar',
				deliveryRate: 'Yetkazish darajasi',
				deliveryRateHint: 'yakunlangan xabarlardan',
			},
			range: {
				today: 'Bugun',
				week: '7 kun',
			...
			onEvent: 'Hodisa boʻyicha',
			manualSend: 'Qoʻlda yuborilgan',
			pollingLive: '{{count}} ta yuborilmoqda · kuzatilmoqda',
			pollingIdle: 'Barchasi yakunlandi · kuzatuv toʻxtagan',
			retryAll: '{{count}} tasini qayta yuborish',
			attemptShort: '{{count}}-urinish',
			sourceRule: 'Qoida #{{id}}',
			sourceManual: 'Qoʻlda',
			broadcastTemplate: 'Ommaviy xabar',
			errorLabel: 'Xatolik',
			...
			field: {
				channel: 'Kanal',
				body: 'Xabar matni',
				scope: 'Kimga yuborish',
				scopeBranch: 'Filial boʻyicha',
				scopeGroup: 'Guruh boʻyicha',
				branch: 'Filial',
				group: 'Guruh',
				scheduledAt: 'Yuborish vaqti',
				scheduledAtHint: 'Boʻsh qoldirilsa darhol yuboriladi',
				bodyPlaceholder: 'Yuboriladigan xabarni yozing…',
			},
			compose: {
				description:
		...
		settings: {
			...
			testFailed: 'Sinov xabarini yuborib boʻlmadi',
			description: 'Provayder, joʻnatuvchi nomi va kunlik cheklov',
			saved: 'Sozlamalar saqlandi',
			loadError: 'Sozlamalarni yuklab boʻlmadi. Sahifani yangilang.',
			masterSwitch: 'SMS yuborishni yoqish',
			masterSwitchHint:
				'Tizimdagi barcha SMS uchun asosiy tugma — u oʻchirilganda qoidalar, qoʻlda yuborish va qayta urinishlar hammasi toʻxtaydi.',
			notOperational:
				'SMS yoqilgan, lekin yuborish mumkin emas — provayder maʼlumotlari toʻliq emas.',
			balanceUnknown: 'Balans maʼlum emas',
			channelCard: {
				title: 'SMS kanali',
			...
			field: {
				...
				login: 'Provayder login',
				password: 'Provayder siri',
				credentialsHint:
					'Faqat yozish uchun — saqlangan maʼlumotlarni oʻzgartirmaslik uchun ikkalasini ham boʻsh qoldiring. Sirlar API orqali hech qachon qaytarilmaydi.',
			...
			credentials: {
				...
				clear: 'Saqlangan maʼlumotlarni tozalash',
			...
			balance: {
				...
				fetched: 'yangilandi {{date}}',
			},
			test: {
				title: 'Sinov yuborish',
				description:
					'Haqiqiy provayder orqali oʻtadi va boshqa xabarlar kabi hisoblanadi.',
				phone: 'Telefon',
				message: 'Xabar (ixtiyoriy)',
				messagePlaceholder:
					'Standart holatda qisqa provayder tekshiruvi yuboriladi.',
				send: 'Sinov yuborish',
		...
		audience: {
			STUDENT: 'Oʻquvchi',
			PRIMARY_GUARDIAN: 'Ota-ona',
			STUDENT_AND_GUARDIAN: 'Oʻquvchi va ota-ona',
			BILLING_CONTACTS: 'Markaz rahbariyati',
		},
		status: {
			QUEUED: 'Navbatda',
