	...
	notifications: {
		...
		templates: {
			...
			preview: {
				title: 'Предпросмотр',
				run: 'Показать',
				empty: 'Введите текст и нажмите, чтобы увидеть результат.',
				segments: '{{count}} SMS',
				segmentsHint:
					'Кириллица и буква ʻ дают 70 символов на часть вместо 160 для латиницы — поэтому стоимость отличается.',
			},
			...
			livePreviewHint: 'на примерных данных · ничего не отправляется',
			previewFrom: 'от {{sender}}',
			segmentsCounted: 'считается по готовому сообщению, а не по исходному тексту',
			charCount: '{{chars}} симв. · {{encoding}} · {{segments}} сегм.',
			previewMeta:
				'{{segments}} сегм. · {{encoding}} · {{chars}}/{{perSegment}} симв. на сегмент',
