	...
	notifications: {
		...
		settings: {
			...
			ownerOnly: {
				...
				description:
					'Настройки провайдера несут риск для платежей центра, поэтому эту вкладку видит только OWNER. Администраторы и менеджеры по-прежнему получают правила, шаблоны и историю отправок.',
			},
			validation: {
