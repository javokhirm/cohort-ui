 ...
 * lapsed — a 402 on any teach route, or `subscription.hasAccess === false` from
 * login/refresh. The authed layout renders this in place of the shell, so no
 * teach screen is reachable and manual URL entry cannot bypass it.
 *
 * Read-only by design: a teacher cannot pay — only an OWNER on the admin console
