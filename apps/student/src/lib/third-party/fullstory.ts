...
/**
 * Ties the current FullStory session to the signed-in student. No-ops until
 * FullStory has booted. Like `apps/teacher`, this surface's `AuthResult` carries
 * no tenant object and no boot profile fetch (no `/student/me` on boot) — the
