...
/**
 * Route guards (docs/auth-and-rbac.md §7). UI gating is cosmetic — the backend enforces
 * every rule via its StudentApi role guard — but keeps a non-student out of a console
