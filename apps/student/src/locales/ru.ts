...
export const ru: TranslationsOf<typeof uz> = {
	...
	progress: {
		...
		noResultsDescription:
			'Когда преподаватель опубликует результат, он появится здесь вместе с отзывом.',
		attendanceRateTitle: 'Уровень посещаемости',
		attendanceRateSub: 'По всем группам',
		streakTitle: '{{count}} занятий подряд',
		streakSub: 'Так держать!',
		lastClasses: 'Последние {{count}} занятий',
		historyTitle: 'История',
		noHistoryTitle: 'Записей о посещаемости нет',
		noHistoryDescription:
			'Когда занятия будут отмечены, посещаемость появится здесь.',
